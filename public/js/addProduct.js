...
const validateForm = () => {
    if(!productName.value.length){
    ...
    } else if(!imagePaths.length){ //image link carry
        return showAlert('upload atleast one image of product')
        ...
        return showAlert('you missed pricing details');
    } else if(stock.value < 20){
        return showAlert('you should minimum 20 items in stock');
